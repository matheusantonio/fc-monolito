...
describe("Product repository test", () => {
    ...
    it("should find a product", async () => {
        ...
        expect(productResult.id.id).toEqual("1",);
        expect(productResult.name).toEqual("Product 1");
        expect(productResult.description).toEqual("Product 1 description");
        expect(productResult.purchasePrice).toEqual(100);
        expect(productResult.stock).toEqual(10);
    });
});